...
class ExpenseWindow(XinguWindow):
    ...
    def __init__(self, root_window):
        ...
        self.ExpenseFrame=Frame(self,bg="Purple",width=450,height=500)
        ...
        #Field
        self.FieldLabel = Label(self.ExpenseFrame, text="Campo:", bg="Purple", fg="White", font=("Calibri", 14))
        self.FieldLabel.place(x=50, y=100)

        self.mode_field_list = ["Comida", "Hogar", "Transporte", "Ocio", "Salud", "Ropa", "Viajes", "Caprichos", "Regalos", "Otros"]
        ...
        #Type
        self.TypeLabel = Label(self.ExpenseFrame, text="Tipo:", bg="Purple", fg="White", font=("Calibri", 14))
        self.TypeLabel.place(x=50, y=150)

        self.mode_type_list = ["Mensual", "Puntual"]
        self.mode_type = StringVar(self)
        self.mode_type.set(self.mode_type_list[0])
        self.ModeType = OptionMenu(self.ExpenseFrame, self.mode_type, *self.mode_type_list)
        self.ModeType.config(width=18, font=('Calibri', 14))
        self.ModeType.place(x=200,y=150)
